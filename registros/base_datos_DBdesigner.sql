...
CREATE TABLE Clientes (
  id_cliente TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE Pedidos (
  ...
  peso FLOAT NULL,
  cantidad_producto TINYINT NULL,
...
CREATE TABLE Productos_de_pedidos (
  Productos_id_producto TINYINT UNSIGNED NOT NULL,
  Pedidos_id_pedido TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE Facturas (
  id_factura TINYINT UNSIGNED NOT NULL,
  Pedidos_id_pedido TINYINT UNSIGNED NOT NULL,
  Clientes_id_cliente TINYINT UNSIGNED NOT NULL,
